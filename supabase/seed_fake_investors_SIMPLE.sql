-- =====================================================
-- FAKE INVESTOR PROFILES - SIMPLE VERSION
-- =====================================================
-- Created: December 14, 2024
-- Purpose: Generate realistic investor personas for MVP demo
-- Method: Create users via auth.users, then update profiles

-- =====================================================
-- IMPORTANT: Check if users already exist first!
-- =====================================================

-- Check existing users
SELECT email FROM auth.users WHERE email LIKE 'demo+investor%@infyra.ai';

-- If any exist, delete them first (optional):
-- DELETE FROM auth.users WHERE email LIKE 'demo+investor%@infyra.ai';
...
-- Wait a moment for the trigger to create profiles...
...
-- Should show 10 profiles created by trigger

-- =====================================================
-- STEP 3: Update profiles with detailed information
-- =====================================================
